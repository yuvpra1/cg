    ...
    <div className="container" style={{ paddingTop: '60px', paddingBottom: '60px' }}>
      ...
      <div className="marquee-container" style={{ margin: '0 auto 50px', borderRadius: '4px', maxWidth: '800px' }}>
        <div className="marquee-content">
          <span style={{ paddingRight: '40px' }}>🔥 <a href="/cg-gk/chhattisgarh-prehistoric-period" style={{ color: 'inherit', textDecoration: 'none' }}>NEW - छत्तीसगढ़ का प्राचीन इतिहास: प्रागैतिहासिक काल से महाभारत काल तक</a></span>
